import ActiveToggleDropdownItem from "@/components/products/DropdownMenuActionItems.tsx";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function ProductsPage() {
  return (
    <>
      <h1 className="text-xl md:text-4xl w-full md:max-w-4xl mx-auto my-10">
        Products
      </h1>
      <ProductsTable />
    </>
